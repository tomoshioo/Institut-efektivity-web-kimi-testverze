...
const VisionSection: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="ie-section-pinned bg-[#0B0C0F] z-20"
      id="onas"
    >
      {/* Background gradient */}
      <div 
      ...
      <div className="relative w-full h-full">
        ...
        >
          ...
          <p className="ie-headline-3 text-[#00F0FF]">
            Vytváříme systém, který slouží lidem.
          </p>
        </div>
        ...
        >
          Mapujeme procesy, odstraňujeme duplicity a navrhujeme služby, 
          které jsou srozumitelné, rychlé a měřitelné. Od strategie po implementaci.
        </p>
